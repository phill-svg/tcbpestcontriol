...
var src_default = {
  async fetch(request, env) {
    ...
    if (response.status === 200 && contentType.includes("text/html")) {
      ...
      return new HTMLRewriter().on('link[rel="canonical"]', {
        element(el) {
...
// .wrangler/tmp/bundle-rd7xGQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-rd7xGQ/middleware-loader.entry.ts
